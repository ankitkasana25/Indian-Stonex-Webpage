  ...
  const features = [
    {
      ...
      description:
        "Decades of experience in traditional and modern stone artistry with meticulous attention to detail",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Premium quality stones sourced from trusted quarries ensuring durability and elegance",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Tailored designs to match your vision and architectural requirements",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-light mb-6">
              Why Choose{" "}
              <span className="font-semibold text-theme">Our Services</span>
            </h2>
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
              ...
              deliver exceptional stone work that stands the test of time and
          ...
          <div className="text-center mt-16">
            <div className="bg-white rounded-2xl shadow-lg p-8 max-w-4xl mx-auto border border-gray-100">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                ...
                for your stone work requirements.
              </p>
              <button
